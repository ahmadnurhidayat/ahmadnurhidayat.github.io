...
Automate MikroTik firewall management with an Express.js API — add/remove IPs from address lists via REST API. Built for CI/CD scenarios where runners have dynamic IPs and need temporary whitelist entries with auto-expiring TTL.

[Read full guide →](https://docs.beyondyou.my.id/01-knowledge-base/system/mikrotik-firewall-automation-expressjs/)
